            ...
            <div className="row footer dark-grey">
              {/* <h1>KG COLLECTIVE REAL ESTATE</h1> */}
                ...
                <div className="social mx-auto col-12 col-sm-8">
                    <a href="https://www.instagram.com/kgcollectivere/" target="_blank"><p className="phone col-12 col-sm-4 fa fa-instagram fa-2x"></p></a>
                    <a href="https://www.facebook.com/kgcollectiverealestate/" target="_blank"><p className="address col-12 col-sm-4 fa fa-facebook fa-2x"></p></a>
                </div>
            </div>
        )
    }
